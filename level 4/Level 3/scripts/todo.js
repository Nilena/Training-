...
function act() {
    if(f===null){
        $(btn[2]).attr("class","btn active");
         $(btn[1]).attr("class"," btn");
           $(btn[0]).attr("class","btn");
    }
    else if (f===true){
        $(btn[1]).attr("class","btn active");
         $(btn[2]).attr("class"," btn");
           $(btn[0]).attr("class","btn");
    }
    else if(f === false) {
        $(btn[0]).attr("class","btn active");
          $(btn[2]).attr("class"," btn");
            $(btn[1]).attr("class","btn");
    }
}
